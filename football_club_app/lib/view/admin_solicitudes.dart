      ...
      return Row(
        ...
        children: [
          ...
          InkWell(
            ...
            onTap: () {
              ...
              final docSol = FirebaseFirestore.instance
                                        .collection('solicitudes').doc(socio.email.toString());
                      docSol.delete();
          ...
          InkWell(
            ...
            onTap: () {
              crearSocio(socio.nombre.toString(), socio.apellidos.toString(), socio.alias, socio.email.toString(), socio.password.toString(), socio.telefono.toString(), false, usuarioActivo);
