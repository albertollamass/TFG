...
class _DatosPersonalesState extends State<DatosPersonales> {
  ...
  final ButtonStyle styleInic =
        ElevatedButton.styleFrom(textStyle: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold), backgroundColor: const Color(0xff3C3577), padding: const EdgeInsets.fromLTRB(90.0,16.0,90.0,16.0));
  @override
